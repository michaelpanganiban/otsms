...
class Main extends Controller
{
    ...
    public function dashboard(){
        ...
        $data_orders = DB::select("SELECT SUM(p.amount) as amount FROM product_sales p LEFT JOIN orders o ON p.product_id = o.product_id WHERE MONTH(o.created_at) IS NOT NULL AND MONTH(o.created_at) = MONTH(CURRENT_DATE()) AND o.status NOT IN('Pending', 'Disapproved')");
        ...
        return view('home', compact('data_orders', 'custom'));
    }
